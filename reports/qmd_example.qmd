...
![](../results/horse_pops_plot.png){fig.cap="Horse populations for all provinces in Canada from 1906 - 1972." fig.label="fig:horse_population_prov"}
...
Additionally, note that in @tbl-horse we consider the sample standard deviation of the number of horses during the same time span as Figure 1.

![](../results/horse_pop_plot_largest_sd.png){fig.cap="Horse populations for the province with the largest standard deviation" fig.label="fig:horse_population_sd" width=60%}

Figure \@ref(fig:horse_population_sd): Horse populations for the province with the largest standard deviation
